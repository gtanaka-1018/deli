...
const ANALYTICS_FILTER = "environment eq 'production' and (requestPath eq '/' or requestPath eq '/referral/x' or requestPath eq '/referral/instagram' or requestPath eq '/referral/share' or requestPath eq '/referral/erabibase')";
